...
# # python extract_feature2.py --weights /home/xavier21/projects/def-josedolz/xavier21/SC-CAM/weights/res38_cls.pth --infer_list ./voc12/train_aug.txt --voc12_root /home/xavier21/projects/def-josedolz/xavier21/SC-CAM/data/VOCdevkit/VOC2012 --save_folder ./save_temp --k_cluster 10 --from_round_nb 0
...
#     parser.add_argument("--voc12_root", default="data/VOCdevkit/VOC2012", type=str, help="the path to the dataset folder")
...
#     infer_dataset = voc12.data.VOC12ClsDatasetMultiCrop(args.infer_list, voc12_root=args.voc12_root, size_crops=[224],
#         nmb_crops=[2],
...
#         # if iter >8:
#         #     img = np.array(img_list[0][0])
#         #     print(img.shape)
#         #     img = img.swapaxes(0,1)
#         #     img = img.swapaxes(1,2)
#         #     imgplot = plt.imshow(img)
#         #     plt.savefig('temp.jpg')
#         #     img = np.array(img_list[1][0])
#         #     print(img.shape)
#         #     img = img.swapaxes(0,1)
#         #     img = img.swapaxes(1,2)
#         #     imgplot = plt.imshow(img)
...
#                 tmp, feature, _ = model.forward(img_list[i].cuda(), args.from_round_nb)
...
if __name__ == '__main__':
    ...
    for iter, (img_name, img_list, label) in enumerate(infer_data_loader):
        ...
        for img in img_list:
            ...
            # extract feature
            if args.from_round_nb == 0:
                tmp, feature, _ = model.forward(img.cuda(), args.from_round_nb)
            else:
                tmp, feature, y_20, x_200, y_200 = model.forward(img.cuda(), args.from_round_nb)
